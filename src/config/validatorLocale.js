...
export const configValidatorFr = () =>
  SimpleReactValidator.addLocale("fr", {
    accepted: "Le champ :attribute doit être accepté.",
    after: "Le champ :attribute doit être après :date.",
    after_or_equal:
      "Le champ :attribute doit correspondre ou bien être après :date.",
    alpha: "Le champ :attribute ne peut contenir que des lettres.",
    alpha_space:
      "Le champ :attribute ne peut contenir que des lettres et des espaces.",
    alpha_num:
      "Le champ :attribute ne peut contenir que des lettres et des chiffres.",
    alpha_num_space:
      "Le champ :attribute ne peut contenir que des lettres, chiffres, et espaces.",
    alpha_num_dash:
      "Le champ :attribute ne peut contenir que des lettres, chiffres, et tirets.",
    alpha_num_dash_space:
      "Le champ :attribute ne peut contenir que des lettres, chiffres, tirets, et espaces.",
    array: "Le champ :attribute doit êttre un tableau.",
    before: "Le champ :attribute doit être avant :date.",
    before_or_equal:
      "Le champ :attribute doit correspondre ou bien être avant :date.",
    ...
    card_num:
      "Le champ :attribute doit être un numéro valide de carte de crédit .",
